  ...
  return (
    <div className="min-h-screen flex  flex-col">
      <div className="border-b min-h-[80dvh] flex justify-center items-center pb-[20px]">
        <div className="md:w-[90%] mx-auto md:mt-4 mt-0  md:min-h-[500px]">
          <div className="font-[700] text-[20px] md:text-[35px] xl:text-[45px] md:leading-[65px] leading-[27px] tracking-[0.64px]">
            Crafting{" "}
          ...
          <p className="text-[14px] md:text-[18px] xl:text-[20px] md:leading-[40px]  xl:leading-[35px] leading-[30px] mt-6 xl:mt-6">
          ...
          <div className="flex mt-10  md:mt-6 gap-4 md:gap-6 justify-between md:justify-center items-center ">
            <Button className="md:text-[15px]  md:max-w-fit flex-1 text-[14px] rounded-full font-[600] md:p-[22px] p-[10px]">
              Find out more
            </Button>
            <Button
              variant="outlined"
              className="border border-black flex-1  md:max-w-fit dark:border-white md:text-[15px] text-[14px] font-[600] md:p-[22px] p-[14px] rounded-full "
            >
              Send a Message
            </Button>
          </div>
      ...
      <div className="  mt-8   md:p-8">
        <h2 className="font-[600] mb-12 text-[20px] md:text-[30px]">
          Projects
        </h2>

        <ProjectsSection />
        <div className=" pt-16 mt-18">
          <h2 className="   md:text-[30px] text-[20px] mb-4  font-[600]">
            Visual Design Works
          </h2>
          ...
          <div className="flex flex-row  overflow-auto md:flex-col gap-6 mt-12">
            <div className=" flex gap-6">
              <div className="bg-[#023F7E] w-[100vw]  overflow-clip   md:flex-1   p-6 ">
                <h3 className=" md:text-[30px] text-white text-[18px] font-[600]">
                  Suitroh
                </h3>
                <p className="text-[14px] md:text-[18px] text-white   md:leading-[28px] leading-[20px] mt-2">
                  I believe great design balances user needs, visual appeal, and
                  seamless interacte With a degree in{" "}
                </p>

                <div className=" w-[90%] h-fit m-auto mt-4">
                  <img
                    src={Suitor}
                    alt=""
                    className=" w-[100%] max-w-[550px] m-auto mt-8"
                  />
                </div>
              </div>
              <div className="bg-white w-[100vw] md:max-h-[600px] max-h-[500px] overflow-clip sm:max-h-[400px]  md:flex-1   p-6  max-w-[45%]">
                {" "}
                <h3 className=" md:text-[30px] text-black text-[18px] font-[600]">
                  Kudiwave
                </h3>
                <p className="text-[14px] md:text-[18px] text-black  md:leading-[28px] leading-[20px] mt-2">
                  Looking to simplify your finances? Send, save, and manage your
                  money effortlessly with Kudiwave
                </p>
                <div className=" w-[80%] h-fit m-auto mt-4">
                  <img
                    src={Kudiwave}
                    alt=""
                    className=" w-[100%] max-w-[500px] m-auto mt-8"
                  />
                </div>
              </div>
            </div>
